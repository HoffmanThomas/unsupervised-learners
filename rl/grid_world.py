    ...
    for i in range(0,4):
        for j in range(0,4):
            if (state[i,j][level] == 1):
                return i,j #can identify superimposed elements, whereas findLoc would miss it (intentionally) if there was superimposition.

# player code is 3 pit code is 1 and goal code 0 
def getReward(state):
